<template>
  <div class="d-flex flex-column tasks">
    <h1 class="form-title">Tasks</h1>

    <div class="mb-4 mt-2 d-flex flex-wrap justify-content-center">
      <router-link to="/tasks/new" class="btn btn-outline-success ml-2" exact
      ...
      <div>
        <b-modal id="modal1" ref="modal" centered title="Delete Confirmation">
          ...
          <div slot="modal-footer" class="w-100 text-right">
            <b-btn slot="md" class="mr-1" variant="danger" @click="deleteTask"
              >Delete</b-btn
            >
            <b-btn slot="md" variant="secondary" @click="cancelModal"
              >Cancel</b-btn
            >
          </div>
        </b-modal>
